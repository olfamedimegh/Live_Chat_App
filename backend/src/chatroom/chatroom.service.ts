...
export class ChatroomService {
  ...
  async createChatroom(name: string, sub: number) {
   // nchoufou fama chatroom nefiss el isssim welle
  ...
  // louken user fel chatroom bech traje3 el last msg mte3 el chatrooms el koll bech fel front tnajem tra last msg me8ir lel chats el koll
  ...
  // this will return all the msg from a specific chatroom
